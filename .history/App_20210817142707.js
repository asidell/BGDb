...
export default class App extends Component {
  ...
  render(){
    ...
    function makeElements(gameData,{naviagtion}){
      let allData=[]
    ...
    console.log(gameData2[0].gameID)
    gameData2.forEach(element => {
        ...
        <View style={styles.container}>
          <ScrollView>
            ...
            <Table borderStyle={{borderWidth: 2, borderColor: '#c8e1ff'}}>
              <Rows data={makeElements(Games,{naviagtion})[0]} textStyle={styles.text}/>
            </Table>
          </ScrollView>
        </View>
      );
