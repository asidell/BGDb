...
import { Button, Image, StyleSheet, Text, View, ScrollView,TouchableOpacity,Linking, Alert, AsyncStorage} from 'react-native';
      ...
      return(
        <View style ={styles.container}>
          <ScrollView>
            ...
            <Button title="Add Game" onPress={()=> _storeData(gameSelect["gameID (S)"])}/>
