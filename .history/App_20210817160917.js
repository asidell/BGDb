...
import { Button, Image, StyleSheet, Text, View, ScrollView,TouchableOpacity,Linking, Alert, AsyncStorageStatic} from 'react-native';
  ...
  render(){
    ...
    function makeElements(gameData,{navigation}){
      ...
      for(let i=0;i<gameData.length;i++){
        allData.push([
          <TouchableOpacity onPress={()=> navigation.navigate('Game Screen', Games[i]["gameID (S)",Games[i]["Name (S)"]])}>
