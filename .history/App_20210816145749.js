...
import { Button, Image, StyleSheet, Text, View, ScrollView,TouchableOpacity,Linking,DataTable } from 'react-native';
  ...
  const MyHomeScreen = ({navigation}) => {
    ...
    return(
      <ScrollView>
        ...
        <Button onPress={()=>handleFile()} title="Load Data"/>
        <Text>
          <CsvToHtmlTable data = './assets/Games.csv' csvDelimiter ='","' tableClassName="table table-striped table-hover"/>
