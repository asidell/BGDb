...
import { Button, Image, StyleSheet, Text, View, ScrollView,TouchableOpacity,Linking, Table } from 'react-native';
  ...
  const MyHomeScreen = ({navigation}) => {
    ...
    return(
      <ScrollView>
        ...
        <Table data={Games} onSelect={row => setCurrent(row)}>
          <Table.Col name = "Name (S)" header= "Name"/>
        </Table>
